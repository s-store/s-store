...
public class SimpleMimicClient {
	final int port;
	String hostname;
	Catalog catalog;
	Client client;
	...
	SimpleMimicClient(String hostname) {
    ...
    /* Code that needs to be modified for capstone */
    ...
    /* Code that needs to be modified for capston */
	...
	public static void main(String [] args) {
		...
		JSONObject j;
		VoltTable [] results;
		SimpleMimicClient myc;
		if (args[0] != null) {
			myc = new SimpleMimicClient(args[0]);
		} else {
			myc = new SimpleMimicClient("localhost");
		}
		try {
